export function HomeHero() {
  return (
    <div className="flex flex-col justify-center">
      <span className="mb-4 inline-flex w-fit items-center rounded-full border border-white/60 bg-white/60 px-4 py-2 text-sm font-medium text-stone-700 shadow-[0_10px_30px_rgba(62,39,35,0.08)] backdrop-blur">
      ...
      <div className="mt-8 grid gap-3 text-sm text-stone-700 sm:grid-cols-3">
        <div className="rounded-3xl border border-white/70 bg-white/65 p-4 shadow-[0_12px_40px_rgba(62,39,35,0.08)] backdrop-blur">
